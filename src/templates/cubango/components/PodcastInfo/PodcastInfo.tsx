...
const PodcastInfo: React.FC<Props> = ({
  ...
  const podcastDescriptionClasses = `podcast-info__content__description ${
  ...
  const renderBadges = () =>
    podcast.categories.map((category, i) => (
      <span
        className="podcast-info__badge"
        key={`category_${i}`}
        style={{ borderColor: textColorOnPrimary }}
      >
        {category}
      </span>
    ));
  ...
  return (
    <section className="podcast-info">
      <div
        className="podcast-info__header"
      ...
      <div className="podcast-info__content">
        <div className="podcast-info__content-inner">
          ...
          <div
            className={podcastDescriptionClasses}
            dangerouslySetInnerHTML={{
              __html: sanitize(podcast.description ?? "") || "",
            }}
          ></div>
          <button
            className="podcast-info__content__description-toggle"
